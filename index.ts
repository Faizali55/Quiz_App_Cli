...
console.log(chalk.magenta("Each Question Of Is 5 Marks\n"));
...
let userInput = await inquirer.prompt([
  ...
  },
  {
    ...
    type: "list",
    message:
      "7.What Is The Name Of The Largest Province In Pakistan By Land Area?",
  ...
  },
  {
    ...
    type: "list",
    message:
      "8.Which Pakistani Scientist Won The Nobel Prize In Physics In 1979?",
    choices: [
      "Dr.Abdul Qadeer",
      "Dr.Abdus Salam",
      "Dr.Allama Iqbal",
...
if (question1 === "jasmine") marks += 5;
if (question2 === "Karachi") marks += 5;
if (question3 === "Liaquat Ali Khan") marks += 5;
if (question4 === "K2") marks += 5;
if (question5 === "Indus") marks += 5;
if (question6 === "Islamabad") marks += 5;
if (question7 === "Balochistan") marks += 5;
if (question8 === "Dr.Abdus Salam") marks += 5;
if (question9 === "Al-Khalid") marks += 5;
if (question10 === "Karachi Naval Base") marks += 5;
