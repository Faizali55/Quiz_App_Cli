...
if (question2 === "Karachi")
    marks += 5;
if (question3 === "Liaquat Ali Khan")
    marks += 5;
if (question4 === "K2")
    marks += 5;
if (question5 === "Indus")
    marks += 5;
if (question6 === "Islamabad")
    marks += 5;
if (question7 === "Balochistan")
    marks += 5;
if (question8 === "Dr.Abdus Salam")
    marks += 5;
if (question9 === "Al-Khalid")
    marks += 5;
if (question10 === "Karachi Naval Base")
    marks += 5;
console.log(marks);
function myAnswer() {
